...
if __name__ == '__main__':
    ...
    parser.add_argument('--questions', type=str,
                        default='../data/vqa/Bangla/Bangla_Val_Ques_150K.json',
                        help='Path for train annotation file.')
    parser.add_argument('--annotations', type=str,
                        default='../data/vqa/Bangla/Bangla_Val_Ans_150K.json',
                        help='Path for train annotation file.')
    parser.add_argument('--cat2ans', type=str,
                        default='../data/vqa/Bangla/translated_iq_dataset.json',
                        help='Path for the answer types.')
    parser.add_argument('--vocab-path', type=str,
                        default='../data/processed/Bangla/vocab_iq.json',
    ...
    parser.add_argument('--cat2name', type=str,
                        default='../data/processed/Bangla/cat2name.json',
    ...
    # Train or Val?
    parser.add_argument('--val', type=bool, default=True, help="whether we're working with the validation set or not")
    ...
    if args.val == True: 
        ...
        vocab = build_vocab('../data/vqa/Bangla/Bangla_Train_Ques_220K.json',
                            '../data/vqa/Bangla/translated_iq_dataset.json', 4)
        # vocab = pickle.load(open("vocab.pkl", "rb"))
        vocab.save(args.vocab_path)
