...
def load_vocab(vocab_path):
    ...
    Returns:
        A Vocabulary object.
    """
    vocab_object = Vocabulary()
    vocab_object.load(vocab_path)
    return vocab_object
...
# When trying to run this specific script, uncomment this section, when trying to use this script as a module, leave this
# part of the code commented.
...
# vocab = build_vocab('../data/vqa/(half)train_2014_questions.json', '../data/vqa/iq_dataset.json', 4)